...
@page { margin: 0; }
	...
	?>
		<header>
			<h1>Invoice</h1>
			<address >
				<p>Corinthia Hotel Khartoum </p>
				<p>Sudan, state white Nile , Corinthia Hotel Khartoum <br>, CKH, <br>Corinthia Hotel Khartoum ,</p>
				<p>+249900370877</p>
			</address>
			<span><img alt="" src="assets/img/log.gif" width="100px"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email : Corinthia Hotel Khartoum@gmail.com || Web : Corinthia Hotel Khartoum.com || Phone : +249900370877 </p>
			</div>
		</aside>
	</body>
</html>
